...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handlAccountException(AccountException e) {
    ...
    public ErrorResponse handlMethodArgumentNotValidException(MethodArgumentNotValidException e) {
